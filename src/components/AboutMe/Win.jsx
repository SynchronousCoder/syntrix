      ...
      <div className="flex flex-col md:flex-row gap-10 mt-[10vh] px-[6vh]">
        ...
        <div className=" relative w-full flex lg:flex-row flex-col items-center justify-center lg:md:w-1/2">
          <img
            ...
            className=" lg:w-full lg:h-[50vh] object-cover rounded-2xl opacity-75 lg:mb-0 mb-[2vh]" // reduced opacity
          />
          <h1
            className="absolute lg:-bottom-[1vw] font-[font1] lg:text-[5vw] lg:top-0 top-[35vh] text-[11vw] font-bold text-white 
        ...
        <div className=" relative w-full flex lg:flex-row flex-col items-center justify-center md:w-1/2">
          ...
          />
          <h1
            className="absolute lg:-bottom-[1vw] font-[font1] lg:text-[5vw] lg:top-0 top-[40vh] text-[11vw] font-bold text-white 
        drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] animate-pulse"
          >
            Performing Design
          </h1>
